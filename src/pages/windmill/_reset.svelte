<script>
	...
	//import ForgotPassword from "./pages/forgot-password.svelte";
	...
	let sidemenu = {
		...
		classClose:
			"transition ease-in-out duration-150 opacity-0 transform -translate-x-20",
		isSidemenu: true,
